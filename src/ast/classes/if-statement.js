 ...
 *
 * Defines an AST node that represents a if statement.
 *
...
/**
 * Defines an AST node that represents a if statement.
 * @typedef {AstFragment} AstIfStatement
 ...
 */
class AstIfStatement extends AstFragment {
    /**
     * Creates an AstIfStatement.
    ...
    mapProperties(properties) {
        ...
        if (!AstFragment.validate(properties.consequent)) {
            throw new TypeError('The consequent be an AstFragment!');
        }

        if (typeof properties.alternative !== 'undefined' && properties.alternative !== null && !AstFragment.validate(properties.alternative)) {
            throw new TypeError('The alternative should be an AstFragment!');
        }
